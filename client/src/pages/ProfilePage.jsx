    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-blue-400 to-green-400 p-4">
      <div className="bg-white p-8 rounded-lg shadow-xl w-full max-w-md">
        <div className="flex flex-col items-center">
          <span className="material-icons text-gray-700 text-6xl" style={{ fontFamily: 'Material Icons' }}>
            account_circle
          </span>
          <h2 className="text-2xl font-bold text-gray-800 mt-4">{authUser?.name}</h2>
        </div>

        <div className="mt-6 space-y-4">
          <div className="flex justify-between border-b pb-2">
            <span className="font-medium text-gray-700">Age:</span>
            <span className="text-gray-900">{authUser?.age}</span>
          </div>

          <div className="flex justify-between border-b pb-2">
            <span className="font-medium text-gray-700">Gender:</span>
            <span className="text-gray-900">{authUser?.gender}</span>
          </div>

        ...
        <div>
          <div className="flex items-center">
            <input
              ...
              className={`h-4 w-4 text-green-600 focus:ring-green-500 border-gray-300 ${
                !hasOpenedModal ? "cursor-not-allowed opacity-50" : ""
              }`}
            />
            <label htmlFor="terms-checkbox" className="ml-2 block text-sm text-gray-900">
              ...
              {!hasOpenedModal && (
                <span className="text-red-500 text-xs ml-2">
                  (Please open the Terms to enable)
                </span>
              )}
            </label>
          </div>
        ...
        <div>
          <button
            ...
            className={`w-full flex justify-center py-2 px-4 border border-transparent rounded-md shadow-sm text-sm font-medium text-white ${
              loading || !isTermsChecked || !isAgeChecked
                ? "bg-green-500 cursor-not-allowed"
                : "bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500"
            }`}
            disabled={loading || !isTermsChecked || !isAgeChecked}
          >
